  ...
  return (
    <section className="py-[30px] lg:py-[120px]">
      <div className="flex flex-col lg:flex-row">
        {/* text */}
        <div>
          <h3 className="h3 mb-6 dark:text-blue-700">
            Grow your profit and track your investments
          </h3>
          <p className="text-slate-700 mb-10 max-w-[408px] dark:text-neutral-300">
            Use advance analytical tools. Clearr TradingView charts let you
            track current and historical profit investments.
          </p>
          <button className="btn px-8 mb-5 mx-auto lg:mx-0 bg-blue-600 hover:bg-blue-700">Learn More</button>
        </div>
        {/* Image */}
        <div
