...
const Trade = () => {
    ...
    return (
        <section className='section lg:pt-[320px] bg-gradient-to-b from-[#f8f9fb] to-[#e2e3e7] dark:from-neutral-900 dark:to-neutral-900 text-gray-600 lg:-mt-[350px] '>
            <div className='container mx-auto '>
                <h2 className='section-title text-center mb-16 dark:text-blue-700'
                    data-aos='fade-up'
                    data-aos-offset='400'>
